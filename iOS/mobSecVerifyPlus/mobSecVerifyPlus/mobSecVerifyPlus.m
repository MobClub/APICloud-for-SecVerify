...
#import "mobSecVerifyPlus.h"

#import "UIColor+Hex.h"
#import "UZAppDelegate.h"
#import "UIImage+mobSecVerify.h"
#import "mobSecVerifyPlus_Defines.h"
...
static NSString *SecVerify_Module_Name = @"mobSecVerifyPlus";
static NSString *SecVerify_CustomUI_Event_Name = @"SecVerifyCustomEvent";

@interface mobSecVerifyPlus () <SVSDKVerifyDelegate>
...
@implementation mobSecVerifyPlus
...
+ (void)onAppLaunch:(NSDictionary *)launchOptions {
    ...
    NSString *appKey = [config objectForKey:@"mobSecVerifyAppKey"];
    NSString *appSecret = [config objectForKey:@"mobSecVerifyAppSecret"];
